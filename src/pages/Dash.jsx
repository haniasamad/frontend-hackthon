...
const Dash = () => {
  ...
  function getdata() {
    axios.get
      ("https://vercel.com/hania-samads-projects/bakend-hackathon-phtb/2aoeVzXrsR43J55wduMz57ej9uXr")
      .then((res) => {
  ...
  const handleDelete = async (id) => {
    await axios.delete("https://vercel.com/hania-samads-projects/bakend-hackathon-phtb/2aoeVzXrsR43J55wduMz57ej9uXr");
  ...
  const handleUpdate = async (id) => {
    ...
    if (updatedTask && updatedDesc) {
      await axios.put("https://vercel.com/hania-samads-projects/bakend-hackathon-phtb/2aoeVzXrsR43J55wduMz57ej9uXr", {
        task: updatedTask,
        desc: updatedDesc,
      });
      getdata()
