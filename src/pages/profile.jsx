...
//     axios.put(`http://localhost:5000/profile/${userId}`, updateUser)
//       .then((res) => {
...
//         <ul className="menu">
//           <li className="disabled"><LuLayoutDashboard />Dashboard</li>
//           <li className="disabled"> <MdTaskAlt />Tasks</li>
...
//           <div className="user">
//              <img
//               src={user.image || "https://www.thewarehouse.pk/cdn/shop/products/60239f50e2c18.jpg?v=1658296185"}
//               alt="User"
//               className="avatar"
//             />
...
//              <img src={user.image || "https://www.thewarehouse.pk/cdn/shop/products/60239f50e2c18.jpg?v=1658296185" } alt="" className='photo' />
